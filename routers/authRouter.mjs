...
// ==========================================
// 1. API สำหรับสมัครสมาชิก (โค้ดใหม่จากโจทย์)
// ==========================================
authRouter.post("/register", async (req, res) => {
  ...
  try {
    ...
    // 3. นำข้อมูลมาบันทึกลงตาราง users ใน Database ของเรา
    ...
    console.error("Register Error:", error); // แนะนำให้เติม console.error เพื่อดูบั๊ก
    res.status(500).json({ error: "An error occurred during registration" });
  }
});

// ==========================================
// 2. API สำหรับเข้าสู่ระบบ (Login) ของเดิม
// ==========================================
